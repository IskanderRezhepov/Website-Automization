...
FIELD_CATEGORIES = [
    {
        ...
        "fields": [
            ...
            ("lessor_representative_iin_bin", "ИИН представителя лизингодателя"),
            ...
            ("insurance_holder_iin_bin", "ИИН/БИН — Страхователь"),
            ("lessee_name", "Лизингополучатель"),
            ("lessor_name", "Лизингодатель"),
            ("lessor_representative_name", "Представитель лизингодателя"),
            ...
            ("direct_debit_sender", "Отправитель денег"),
            ("direct_debit_sender_iin_bin", "ИИН отправителя"),
            ("bank_name", "Банк"),
            ("recipient_name", "Получатель"),
            ("payment_payer", "Плательщик"),
            ("payment_payer_iin_bin", "ИИН/БИН плательщика"),
            ("payment_payee", "Получатель платежа"),
            ("payment_payee_iin_bin", "ИИН/БИН получателя платежа"),
            ("guarantor_iin_bins", "Все ИИН/БИН гарантов"),
        ],
    },
    {
        "key": "bank",
        ...
        "fields": [
            ...
            ("payment_payee_iban", "IBAN получателя платежа"),
    ...
    },
    {
        ...
        "fields": [
            ...
            ("guarantee_contract_numbers", "Все номера договоров гарантии"),
            ("guarantee_contract_date", "Дата договора гарантии"),
            ("guarantee_obligation_scope", "Объём гарантии"),
            ...
            ("linked_purchase_contract_date", "Дата связанного договора купли-продажи"),
            ...
            ("registration_notice_time", "Время уведомления о регистрации"),
            ("insurance_payment_order_number", "Номер платёжного поручения"),
            ("insurance_payment_date", "Дата платежа"),
            ("payment_order_number", "Номер платёжного поручения"),
            ("payment_order_date", "Дата платёжного поручения"),
            ("payment_contract_number", "Договор в назначении платежа"),
            ("payment_invoice_number", "Номер счёта / основания"),
            ("payment_invoice_date", "Дата счёта / основания"),
            ("payment_purpose_code", "Код назначения платежа"),
            ("payment_value_date", "Дата валютирования"),
            ("linked_insurance_policy_number", "Связанный страховой полис"),
    ...
    },
    {
        ...
        "fields": [
            ...
            ("changed_clause", "Изменённый пункт договора"),
            ("changed_commission_percent", "Комиссия по дополнительному соглашению, %"),
            ("minimum_commission_kzt", "Минимальная комиссия, тенге"),
            ...
            ("lease_term_months", "Срок лизинга, месяцев"),
            ("new_term_months", "Новый срок, месяцев"),
            ("new_end_date", "Новая дата окончания"),
            ("new_principal_amount_kzt", "Новая сумма основного долга, тенге"),
            ("purchase_payment_working_days", "Срок оплаты по ДКП, рабочих дней"),
            ("purchase_delivery_working_days", "Срок поставки по ДКП, рабочих дней"),
            ("insurance_payment_amount_kzt", "Сумма страхового платежа, тенге"),
            ("payment_amount_kzt", "Сумма платежа, тенге"),
            ("purchase_payment_calendar_days", "Срок оплаты по ДКП, календарных дней"),
            ("purchase_delivery_calendar_days", "Срок поставки по ДКП, календарных дней"),
            ("purchase_payment_day_type", "Срок оплаты по ДКП: тип дней"),
            ("purchase_delivery_day_type", "Срок поставки по ДКП: тип дней"),
        ],
    },
    {
        "key": "equipment",
        ...
        "fields": [
            ...
            ("property_area_sqm", "Площадь недвижимости, кв. м"),
            ("property_address", "Адрес недвижимости"),
            ("cadastral_number", "Кадастровый номер"),
            ("property_internal_number", "Внутренний номер недвижимости"),
            ("property_market_value_kzt", "Рыночная стоимость недвижимости, тенге"),
        ],
    },
    {
        "key": "insurance",
        ...
        "fields": [
            ...
            ("insured_name", "Застрахованный"),
            ("insured_iin_bin", "ИИН/БИН застрахованного"),
            ("insurance_beneficiary_excess", "Выгодоприобретатель сверх остатка долга"),
            ("beneficiary_excess_iin_bin", "БИН выгодоприобретателя сверх остатка долга"),
    ...
    },
    {
        ...
        "fields": [
            ...
            ("gps_provider_iban", "IBAN поставщика GPS"),
            ("gps_customer_iban", "IBAN заказчика GPS"),
